...
modifier_type_name = {
	...
	percent = yes/no # Should this be formatted as a % by scaling it up
	already_percent = yes/no # Should this be formatted as a % and the actual value itself is already scaled up
	hidden = yes/no # Should this modifier not be displayed
	no_difference_sign = yes/no # Should the +/- difference sign be hidden
